            ...
            <nav className="nav container">
                ...
                <div className={Toggle ? "nav_menu show-menu" : "nav_menu"}>
                    <ul className="nav_list grid">
                        ...
                        <li className="nav_item">
                            <a href="#service" onClick={() => setActiveNav('#service')} className={activeNav === "#service" ? "nav_link active-link" : "nav_link"}>
                                <i className="uil uil-briefcase-alt nav_icon"></i> Services
                            </a>
                        </li>

                        <li className="nav_item">
                            <a href="https://github.com/FaisalArdhani?tab=stars" onClick={() => setActiveNav('#portofolio')} className={activeNav === "#portofolio" ? "nav_link active-link" : "nav_link"}>
