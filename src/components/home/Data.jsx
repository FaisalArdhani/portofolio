...
const Data = () => {
    return (
        <div className="home_data">
            <h1 className="home_title">Faisal A
                <svg
                    width="36"
                    height="36"
                    viewBox="0 0 48 48"
            ...
            <h3 className="home_subtitle">Back-End Developer</h3>
            <p className="home_description">I'm a web developer but I focus on Back-end developers.</p>
